...
clean:
	$S export LC_ALL=en_US.UTF-8 bundle exec jekyll clean
...
## future)
	...
	$S grep -rh --exclude='*summaries.md' 'assign summary_' _includes/ | LC_ALL=en_US.UTF-8 sort >> _includes/helpers/summaries.md
